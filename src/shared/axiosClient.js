...
import {getCountries, topVulnerbilitiesChartConfigue} from "../helpers";
...
export default {
    common: {
        ...
        async getMalwareType(params = {}) {
            return await apiClient.get("malware/type/", {
                params: params
            });
        ...
        async getVulnerbilitiesVendor(params = {}) {
            return await apiClient.get("vulnerabilities/vendors/", {
                params: params
            });
        ...
        async getVulnerbilitiesProducts(params = {}) {
            ...
            return await apiClient.get("vulnerabilities/products/by_vendor/", {
                params: params
            });
            // return axios.get(
    ...
    auth: {
        ...
        async resetPassword(user_id, token, params) {

            return await apiClientUnAuth.post( "accounts/reset-password-confirm/" + user_id + "/" + token + "/", params);
    ...
    vulnerabilities: {
        ...
        async topVulnerbilities(params = {}) {
            return await apiClient.get("vulnerabilities/top_ten_vul_graph/", {
                    params: params
            });
        },
        async topVulnerbilitiesFeature(params = {}) {
            return await apiClient.get("vulnerabilities/featured/", {
                params: params
            });
        }
    },
    malwares: {
       async graph(params = {}) {
        return await apiClient.get("malware/graph/", {
            params: params
        });
        },
        getById(id) {
        ...
        async getMalwareTypes(params = {}) {
            return apiClient.get("malware/type/", {
                params: params
            });
        },
        async getMalwareTypeById(id) {
            return apiClient.get("malware/", {
                params: {
                    _type: id,
                    ordering: '-date'
                }
